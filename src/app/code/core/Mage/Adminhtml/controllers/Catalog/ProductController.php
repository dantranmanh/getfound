...
class Mage_Adminhtml_Catalog_ProductController extends Mage_Adminhtml_Controller_Action
{
    ...
    /**
     * Output specified blocks as a text store
     */
...
//            }
    ...
    protected function _initProductSave()
    {
        ...
        $someData = $this->getRequest()->getPost('merchant_store');
        $product->setData('merchant_store',$someData);
        $product->getResource()->saveAttribute($product,'merchant_store');
     ...
     * @param array $stores store of store pairs: array(fromStore => toStore, fromStore => toStore,..)
