...
class Location_Merchant_AddressController extends Mage_Customer_AddressController
{
    /**
    ...
    public function formAction()
    {
        ...
        $this->loadLayout();
        $this->_initLayoutMessages('customer/session');
        $navigationBlock = $this->getLayout()->getBlock('merchant_account_navigation');
		//var_dump($navigationBlock); exit;
        if ($navigationBlock) {
            $navigationBlock->setActive('merchant/address');
        }
        $this->renderLayout();
    }
