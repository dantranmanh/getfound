<?php
class Location_Merchant_Admin_StoreController extends Mage_Adminhtml_Controller_Action {
    ...
    public function saveAction(){
        ...
        try {
            ...
            $model = Mage::getModel('store/store')->load($param);
            ...
            if($model->save()) {
                ...
                if(isset($param)){
                    ...
                    Mage::getModel('adminhtml/session')->addSuccess(Mage::helper('core')->__('Store has been updated successfully.'));
                    return $this->_redirect("*/*/edit/id/{$param}");
                }else{

                    Mage::getModel('adminhtml/session')->addSuccess(Mage::helper('core')->__('Store has been Added successfully.'));
