...
class Location_Store_Block_List extends Mage_Core_Block_Template{
	...
	public function getCategoryById(){
            ...
            if (!Mage::registry('current_category') && $catId) {
                $catInfo = Mage::getModel('catalog/category')->load($catId);
                Mage::register('current_category', $catInfo);
            }
    ...
    public function getStoreCollection(){
        try {
            if (is_null($this->_storeCollection)) {
                ...
                //echo "&&&&". Mage::getModel('customer/group')->load($groupId)->getCustomerGroupCode();
                if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                    $merchantId = Mage::getSingleton('customer/session')->getCustomerId();
                    if(Mage::getModel('customer/group')->load($groupId)->getCustomerGroupCode() == 'General'){
