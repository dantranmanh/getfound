...
class Location_City_Block_Sortcat extends Location_City_Block_List{
    ...
    protected function _construct()
    {
        ...
        $this->setTemplate('location/city/sortcat.phtml');
    }
    ...
    public function getAlphabatCategoryCollection() {
        try{
            if (is_null($this->_categoryCollection)) {
			  ...
			  $alphabat = $this->getRequest()->getParam('filter');
				...
				$cityTable = Mage::getSingleton('core/resource')->getTableName('city/location');
