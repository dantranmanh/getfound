...
class Location_Store_Block_Admin_Store_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Categories
{
    ...
    public function __construct()
    {
        ...
        $this->setTemplate('store/categories.phtml');
    }
    ...
    public function getIdsString()
    {
		...
		if(Mage::registry('store_categories')){
			$categories = Mage::registry('store_categories');
		}
